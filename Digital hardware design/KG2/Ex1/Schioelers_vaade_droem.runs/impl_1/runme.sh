...
HD_PWD='C:/Users/theil/Schioelers_vaade_droem/Schioelers_vaade_droem.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CeresTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CeresTop.tcl -notrace
