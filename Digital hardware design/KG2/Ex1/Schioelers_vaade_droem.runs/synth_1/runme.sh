...
HD_PWD='C:/Users/theil/Schioelers_vaade_droem/Schioelers_vaade_droem.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CeresTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CeresTop.tcl
