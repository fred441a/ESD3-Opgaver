...
HD_PWD='C:/Users/theil/KG2/EX2/EX2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Toppelop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Toppelop.tcl -notrace
