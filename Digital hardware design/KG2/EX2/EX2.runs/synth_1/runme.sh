...
HD_PWD='C:/Users/theil/KG2/EX2/EX2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Toppelop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Toppelop.tcl
